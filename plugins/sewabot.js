...
╰═══════════════════════`.trim()
    const button = {
        ...
        {title: '1 Minggu', description: "15000\nSewa bot 1 Minggu.", rowId:".masuk"},
        {title: '2 Minggu', description: "20000\nSewa bot 2 Minggu.", rowId:".masuk"},
        {title: '3 Minggu', description: "25000\nSewa bot 3 Minggu.", rowId:".masuk"},
        {title: '1 Bulan', description: "28000\nSewa bot 1 Bulan.", rowId:".masuk"},
        ...
        {title: 'Rules', description: "Rules Bot IZUMI-BOT.", rowId:".snk"},
       ] }],
        listType: 1
       }
